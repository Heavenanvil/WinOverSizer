WinOverSizer - Данная программа позволяет развернуть на весь экран без границ любое (почти) приложение. Поддерживаются горячие клавиши, а также запуск с параметрами.
